 ...
 * `deepseek-harness-cli/working-activity` instead of the bare package name.
 *
 ...
 * `dsh-working-activity` name (a transitive dependency of deepseek-harness-cli) fails
 ...
 * subpath keeps resolution anchored at deepseek-harness-cli itself — always a direct
 * profile dependency — and from its real location `dsh-working-activity`
 * resolves under every package-manager layout.
 * @module deepseek-harness-cli/working-activity
 */
