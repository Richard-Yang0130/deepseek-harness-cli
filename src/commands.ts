...
export const LOCAL_COMMANDS: LocalCommand[] = [
  ...
  { name: 'sessions', description: 'Resume a previous session', tag: 'alias of /resume' },
  ...
  { name: 'stats', description: 'Show session token usage', tag: 'alias of /cost' },
  ...
  { name: 'subagents', description: 'Show subagents of this session', tag: 'alias of /agents' },
  // Model / display
  ...
  { name: 'presets', description: 'Switch the agent preset (including Liangshen mode)', tag: 'alias of /preset' },
  ...
  { name: 'models', description: 'Show the active model', tag: 'alias of /model' },
