 ...
 * tools (the corresponding SKILL.md ships under ~/.dsh/skills with dsh-cli).
 */
...
export function Chat({
  ...
  // title when set, else "DeepSeek Harness CLI"; a `⠂/⠐` spinner prefix while a turn is
  // working (960ms cadence, only while the terminal is focused), a static
  // `✦` otherwise. DeepSeek Harness CLI brands the idle prefix with the DeepSeek whale.
