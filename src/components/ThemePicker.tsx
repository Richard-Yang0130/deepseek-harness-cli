 ...
 * ~/.dsh-cli/themes (sorted by file name). A user theme named `auto` is
 ...
 * every user theme found in ~/.dsh-cli/themes — each row shows the display
 ...
 * ~/.dsh-cli/theme.json and hot swaps), Esc cancels.
 */
