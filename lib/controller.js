...
export class TuiController {
    ...
    async executeHarnessCommand(line) {
        ...
        try {
            ...
            const shownByLifecycle = result?.text !== undefined && this.transcript.some(node => (node.kind === 'command' && node.detail === result.text));
            if (result?.text !== undefined && !shownByLifecycle)
